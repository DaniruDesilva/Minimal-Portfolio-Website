      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            >
              <div className="inline-flex flex-wrap items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-slate-100/90 border border-slate-200/80 text-xs text-slate-700 font-medium leading-normal max-w-full">
                <GraduationCap className="w-4 h-4 text-blue-600 shrink-0" />
                <span>B.Sc (Hons) IT @ University of Moratuwa</span>
                <span className="text-slate-300">•</span>
                <span className="font-mono text-slate-900 font-semibold whitespace-nowrap">GPA 3.57/4.0</span>
              </div>
            </motion.div>
            ...
            >
              <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.1] sm:leading-[1.08] text-balance">
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 pt-1 w-full sm:w-auto"
            >
              <a
                href="#projects"
                onClick={(e) => {
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-medium text-xs sm:text-sm transition-all duration-200 shadow-md shadow-blue-500/20 active:scale-98 cursor-pointer w-full sm:w-auto"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white hover:bg-slate-50 text-slate-800 border border-slate-200 shadow-2xs hover:border-slate-300 font-mono text-xs transition-all active:scale-98 w-full sm:w-auto"
              ...
              >
                {copied ? (
                  ...
                  <>
                    ...
                    <span className="text-slate-700 truncate">{personal.email}</span>
                  </>
                )}
              </button>
            ...
            <motion.div
              ...
              className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3 pt-3 w-full"
            >
            ...
            >
              ...
              <div className="relative p-3.5 bg-white/95 backdrop-blur-xl border border-slate-200/80 rounded-[2rem] shadow-[0_20px_50px_-15px_rgba(0,0,0,0.08)] transition-all">
                ...
                <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[1.5rem] bg-slate-100">
                  ...
                  <div className="absolute bottom-3 left-3 right-3 sm:right-auto z-10 max-w-[calc(100%-1.5rem)]">
                    <div className="bg-white/90 backdrop-blur-md border border-white/80 rounded-xl px-3.5 py-2 shadow-lg shadow-black/5 flex items-center gap-3">
                      ...
                      <div className="flex flex-col min-w-0">
                        ...
                        <span className="text-[11px] font-medium text-slate-500 leading-tight mt-0.5 truncate">
                          University of Moratuwa
                        </span>
                      </div>
                    </div>
